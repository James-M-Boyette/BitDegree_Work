...
// Description: In order to keep your app clean and readable, you are going to need to create individual modules tohandle special tasks. See if you can create a basic node app that, when run, does arithmetic by importing a special, seperate "multiplcation" module!
...
// STEP 2: Navigate into this folder in terminal and run npm init -y
